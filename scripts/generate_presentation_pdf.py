...
Uses ultra-crisp, high-contrast executive styling with 100% visible typography.
"""
...
SUCCESS_GREEN = colors.HexColor("#059669")   # Green
GOLD_ACCENT = colors.HexColor("#B45309")     # Amber / Gold


class PresentationCanvas(canvas.Canvas):
    """Two-pass canvas for dynamic slide numbering without painting over content."""
...
def generate_deck():
    ...
    slide_title = ParagraphStyle('STitle', fontName='Helvetica-Bold', fontSize=22, leading=26, textColor=TITLE_COLOR)
    slide_sub = ParagraphStyle('SSub', fontName='Helvetica', fontSize=10.5, leading=14, textColor=MUTED_TEXT)
    card_h = ParagraphStyle('CardH', fontName='Helvetica-Bold', fontSize=10.5, leading=14, textColor=TITLE_COLOR)
    ...
    prob_content = [
        Paragraph("<font color='#DC2626'><b>THE COMMERCIAL FACILITY CHALLENGE</b></font>", card_h),
        Spacer(1, 6),
    ...
    sol_content = [
        Paragraph("<font color='#059669'><b>THE AQUAGUARD AI AUTONOMOUS SOLUTION</b></font>", card_h),
        Spacer(1, 6),
    ...
    comp_table.setStyle(TableStyle([
        ('BACKGROUND', (0, 0), (0, 0), colors.HexColor("#FEF2F2")),  # Soft red tint
        ('BACKGROUND', (1, 0), (1, 0), colors.HexColor("#F0FDF4")),  # Soft green tint
        ('BOX', (0, 0), (0, 0), 1.2, ALERT_RED),
        ('BOX', (1, 0), (1, 0), 1.2, SUCCESS_GREEN),
    ...
    ribbon_p = Paragraph(
        "<font color='#0077B6'><b>CORE TRANSFORMATION:</b></font>  "
        ...
        ParagraphStyle('Ribbon', fontName='Helvetica-Bold', fontSize=9, leading=13, textColor=TITLE_COLOR, alignment=1))
    ...
    stage1 = [
        Paragraph("<font color='#0077B6'><b>1. INGESTION &amp; TWIN</b></font>", card_h),
        Spacer(1, 4),
    ...
    stage2 = [
        Paragraph("<font color='#B45309'><b>2. DETECTION &amp; ML</b></font>", card_h),
        Spacer(1, 4),
    ...
    stage3 = [
        Paragraph("<font color='#DC2626'><b>3. INCIDENT INTEL</b></font>", card_h),
        Spacer(1, 4),
    ...
    stage4 = [
        Paragraph("<font color='#059669'><b>4. VERIFY &amp; LEDGER</b></font>", card_h),
        Spacer(1, 4),
    ...
    ai_box = [
        Paragraph("<font color='#0077B6'><b>GROUNDED AI COMMAND CENTER (REACT REASONING LAYER)</b></font>", card_h),
        Paragraph(
    ...
    ai_table.setStyle(TableStyle([
        ('BACKGROUND', (0, 0), (-1, -1), colors.HexColor("#F0F9FF")),  # Soft blue tint
        ('BOX', (0, 0), (-1, -1), 1, KOHLER_BLUE),
    ...
    d1 = [
        Paragraph("<font color='#0077B6'><b>STEP 1: INJECT LEAK</b></font>", card_h),
        Spacer(1, 4),
    ...
    d2 = [
        Paragraph("<font color='#DC2626'><b>STEP 2: DETECTION &amp; CAD</b></font>", card_h),
        Spacer(1, 4),
    ...
    d3 = [
        Paragraph("<font color='#B45309'><b>STEP 3: 1-CLICK DISPATCH</b></font>", card_h),
        Spacer(1, 4),
    ...
    d4 = [
        Paragraph("<font color='#059669'><b>STEP 4: VERIFY &amp; BANK</b></font>", card_h),
        Spacer(1, 4),
    ...
    inno1 = [
        Paragraph("<font color='#0077B6'><b>Acoustic Cavitation Hydrophone</b></font>", card_h),
    ...
    inno2 = [
        Paragraph("<font color='#0077B6'><b>Exploded CAD Schematics</b></font>", card_h),
    ...
    inno3 = [
        Paragraph("<font color='#0077B6'><b>National Portfolio Fleet</b></font>", card_h),
    ...
    q1 = [
        Paragraph("<font color='#0077B6'><b>WATER STEWARDSHIP</b></font>", card_h),
        Spacer(1, 4),
    ...
    q2 = [
        Paragraph("<font color='#059669'><b>OPERATIONAL EXCELLENCE</b></font>", card_h),
        Spacer(1, 4),
    ...
    q3 = [
        Paragraph("<font color='#B45309'><b>PREDICTIVE ASSET HEALTH</b></font>", card_h),
        Spacer(1, 4),
    ...
    q4 = [
        Paragraph("<font color='#B45309'><b>ESG &amp; GREEN BUILDING</b></font>", card_h),
        Spacer(1, 4),
    ...
    mantra = Paragraph(
        ...
        ParagraphStyle('Mantra', fontName='Helvetica-Bold', fontSize=12, leading=16, textColor=colors.white, alignment=1))
